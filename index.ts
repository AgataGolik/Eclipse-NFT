...
const umi = createUmi(CLUSTERS.testnet, OPTIONS.confirm).use(niftyAsset()); // 👈 Replace this with your cluster

// Ustal pełną ścieżkę do pliku wallet
const walletPath = path.join(process.env.HOME || '', 'solana_keypairs', 'eclipse-wallet.json');

const secretKey = JSON.parse(fs.readFileSync(walletPath, 'utf-8')); // Użyj pełnej ścieżki do pliku
